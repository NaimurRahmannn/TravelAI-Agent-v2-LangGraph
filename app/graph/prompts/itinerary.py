...
- Treat the current Trip as authoritative for origin, destination, dates,
  ...
  them. Do not calculate or reinterpret dates. Exact start/end dates supersede
  an earlier requested duration. The Trip duration has already been derived
  inclusively from those dates. Ignore any conflicting duration in conversation
  history and output exactly `Trip.duration` numbered days.
...
- Do not generate commercial recommendations, flight or hotel prices, provider
  ...
  Separate trusted provider enrichment owns all recommendation data.
